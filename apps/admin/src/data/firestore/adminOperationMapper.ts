...
export const mapAdminOperation=(document:OperationDocument,internal?:OperationInternalDocument):Operation=>({
 ...
 recipientName:document.recipient.name,recipientPhone:document.recipient.phone,campus:document.recipient.campus,campusCode:document.recipient.campusCode,residence:document.recipient.residence,deliveryLocation:document.recipient.deliveryLocation,deliveryNotes:document.recipient.deliveryInstructions??'',
