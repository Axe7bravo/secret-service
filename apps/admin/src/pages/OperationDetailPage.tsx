...
export function OperationDetailPage() {
  ...
  return <main className="admin-main operation-detail-page">
    ...
    {action && <OperationActionDialog action={action} operationId={operation.operationId} campus={operation.campus} campusCode={operation.campusCode} onCancel={() => setAction(null)} onConfirm={confirm} />}
  </main>;
}
