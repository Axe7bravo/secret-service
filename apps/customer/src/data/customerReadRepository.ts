...
const mockCustomerReadRepository:CustomerOperationReadRepository={list:async():Promise<readonly CustomerOperation[]>=>customerOperationsRepository.list(),getById:async(id)=>customerOperationsRepository.getById(id)};
