...
export const paymentAttemptsFor=(payment:PaymentRecord):PaymentAttempt[]=>{
...
export const paymentHistoryFields=(attempts:PaymentAttempt[])=>({
  attempts,providerCheckoutIds:attempts.map(attempt=>attempt.providerCheckoutId),
});

export const validatePaymentOwnership=(payment:PaymentRecord,operation:OperationRecord):void=>{
